...
class GameLevelDesert {
  constructor(gameEnv) {
    ...
    // Background data
    const image_src_disneyland = path + "/images/gamify/IMG_7640.png"; // be sure to include the path
    const image_data_disneyland = {
        name: 'disneyland',
        greeting: "Welcome to the disneyland!  It is hot and dry here, but there are many adventures to be had!",
        src: image_src_disneyland,
        pixels: {height: 580, width: 1038}
    };


    // Player data for Ali
    const sprite_src_Ali = path + "/images/gamify/Ali.png"; // be sure to include the path
    const ali_before_buffed_up_SCALE_FACTOR = 5;
    const sprite_data_Ali = {
        id: 'Ali',
        greeting: "Hi I am Ali, the desert wanderer. I am looking for wisdom and adventure!",
        src: sprite_src_Ali,
        SCALE_FACTOR: ali_before_buffed_up_SCALE_FACTOR,
        STEP_FACTOR: 1000,
        ANIMATION_RATE: 50,
        INIT_POSITION: { x: 0, y: height - (height/ali_before_buffed_up_SCALE_FACTOR) }, 
    ...
    this.classes = [
      { class: Background, data: image_data_disneyland },
      { class: Player, data: sprite_data_Ali },
