...
<<<<<<< HEAD
    ...
    const sprite_src_ali = path + "/images/gamify/pixil-frame-0__2_-removebg-preview.png"; // be sure to include the path
=======
    // Background data
    const image_src_desert = path + "/images/gamify/IMG_7640.png"; // be sure to include the path
    ...
    console.log('Background data:', image_data_desert);
...
=======
    ...
    const sprite_src_octocat = path + "/images/gamify/alibefore.png"; // be sure to include the path
    const sprite_greet_octocat = "Hi I am Octocat! I am the GitHub code collaboration mascot";
    ...
    console.log('NPC data for Octocat:', sprite_data_octocat);

    // NPC data for Robot
    const sprite_src_robot = path + "/images/gamify/alibefore.png"; // be sure to include the path
    ...
    console.log('NPC data for Robot:', sprite_data_robot);

    // NPC Data for R2D2
    const sprite_src_r2d2 = path + "/images/gamify/alibefore.png"; // be sure to include the path
    ...
    console.log('NPC data for R2D2:', sprite_data_r2d2);
